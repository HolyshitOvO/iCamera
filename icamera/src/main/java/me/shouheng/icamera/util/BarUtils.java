...
//    }
     ...
     * @param fakeStatusBar The fake status bar view.
     */
    public static void setStatusBarCustom(Context context,@NonNull final View fakeStatusBar) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) return;
        Activity activity = getActivityByView(fakeStatusBar);
        if (activity == null) return;
        transparentStatusBar(activity);
     ...
     * @param color         The status bar's color.
     */
    public static void setStatusBarColor4Drawer(Context context,@NonNull final DrawerLayout drawer,
                                                @NonNull final View fakeStatusBar,
                                                @ColorInt final int color) {
        setStatusBarColor4Drawer(context,drawer, fakeStatusBar, color, false);
    }
    ...
    public static void setStatusBarColor4Drawer(Context context,@NonNull final DrawerLayout drawer,
        ...
        setStatusBarColor(context,fakeStatusBar, color);
...
//    }
    ...
    private static Activity getActivityByView(@NonNull final View view) {
        ...
        Log.e("BarUtilsApp", "the view's Context is not an Activity.");
        return null;
    }
