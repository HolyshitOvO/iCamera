...
import me.shouheng.icamera.util.StringUtils;
import me.shouheng.icamerasample.App;
...
public final class SPUtils {
    ...
    private SPUtils(final String spName) {
        sp = App.Companion.app().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SPUtils(final String spName, final int mode) {
        sp = App.Companion.app().getSharedPreferences(spName, mode);
    }

    private static String getDefaultSharedPreferencesName() {
        if (VERSION.SDK_INT >= VERSION_CODES.N) {
            return PreferenceManager.getDefaultSharedPreferencesName(App.Companion.app());
        } else {
            return App.Companion.app().getPackageName() + "_preferences";
        }
    }
